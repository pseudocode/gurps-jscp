...
var libraryName = 'GURPS Basic Set 3rd edition + Compendia';
...
Traits.AppearanceVeryHandsome  = new Trait( "Very Handsome", 'A', 'P', 25, false, "B3E15" );
...
// could do this way
Traits.Appearance          = new Trait( "Appearance" , 'AD', 'P', 5, true, "B3E15" );
...
Traits.Appearance.levelNames
    = [ 'Horrific','Monstrous','Hideous','Revolting','Ugly','Unattractive','Average',
        'Attractive','Good-Looking','Handsome/Beautiful','Very Handsome/Beautiful'];
...
Traits.AbsoluteDirection   = new Trait( "Absolute Direction", 'A', 'M', 5, false, "B3E19" );
...
Traits.AcuteHearing        = new Trait( "Acute Hearing", 'A', 'P', 2, true, "B3E19" );
Traits.AcuteHearing.group = 'hearing';
Traits.AcuteTasteSmell     = new Trait( "Acute Taste/Smell", 'A', 'P', 2, true, "B3E19" );
Traits.AcuteVision         = new Trait( "Acute Vision", 'A', 'P', 2, true, "B3E19" );
...
Traits.Age50plus           = new Trait( "Age", 'D', 'P', -3, true, "B3E27" );
Traits.Age50plus.levelsName = 'year';
...
Traits.Alertness           = new Trait( "Alertness", 'A', 'P', 5, true, "B3E19" );
...
Traits.Ambidexterity       = new Trait( "Ambidexterity", 'A', 'P', 10, false, "B3E19" );
...
Traits.AnimalEmpathy       = new Trait( "Animal Empathy", 'A', 'M', 5, false, "B3E19" );
...
Traits.Awareness           = new Trait( "Awareness", 'A', 'M', 15, false, "CI33" );
...
Traits.BadTemper           = new Trait( "Bad Temper", 'D', "M", -10, false, "B3E31" );
Traits.BadTemper.group = 'temper';
Traits.BadSight            = new Trait( "Bad Sight", 'D', "P", -25, false, "B3E27" );
...
Traits.Bully               = new Trait( "Bully", 'D', 'M', -10, false, "B3E31" );
...
Traits.CodeofHonor         = new Trait( "Code of Honor", 'D', 'M', -5, true, "B3E31" );
...
Traits.CombatReflexes      = new Trait( "Combat Reflexes", 'A', 'M', 15, false, "B3E20" );
Traits.CombatReflexes.group = 'reflexes';
Traits.CommonSense         = new Trait( "Common Sense", 'A', 'M', 10, false, "B3E20" );
...
Traits.CompulsiveBehavior  = new Trait( "Compulsive Behavior", 'D', 'M', -5, true, "B3E32" );
...
Traits.Coward              = new Trait( "Cowardice", 'D', 'M', -10, false, "B3E32" );
...
Traits.DangerSense         = new Trait( "Danger Sense", 'A', 'M', 15, false, "B3E20" );
// Traits.DangerSense.exoticSprntl = 'Supernatural'
Traits.Daredevil           = new Trait( "Daredevil", 'A', 'M', 15, false, "CI23" );
...
Traits.DoubleJointed       = new Trait( "Double-Jointed", 'A', 'P', 5, false, "B3E20" );
...
Traits.Empathy             = new Trait( "Empathy", 'A', 'M', 15, false, "B3E20" );
...
Traits.Gluttony            = new Trait( "Gluttony", 'D', 'M', -5, false, "B3E33" );
Traits.Greed               = new Trait( "Greed", 'D', 'M', -15, false, "B3E33" );
...
Traits.HardOfHearing       = new Trait( "Hard of Hearing", 'D', 'P', -10, false, "B3E28" );
...
Traits.HighPainThreshold   = new Trait( "High Pain Threshold", 'A', 'P', 10, false, "B3E20" );
Traits.HighTechnology1TL   = new Trait( "High Technology, +1 TL", 'A',  'So',  20, false, "CI26" );
Traits.HighTechnology2TL   = new Trait( "High Technology, +2 TLs", 'A', 'So',  50, false, "CI26" );
Traits.HighTechnology3TL   = new Trait( "High Technology, +3 TLs", 'A', 'So', 100, false, "CI26" );
...
Traits.Honesty             = new Trait( "Honesty", 'D', 'M', -10, false, "B3E33" );
...
Traits.ImmunitytoDisease   = new Trait( "Immunity to Disease", 'A', 'P', 10, false, "B3E20" );
...
Traits.Impulsiveness       = new Trait( "Impulsiveness", 'D', 'M', -10, false, "B3E33" );
...
Traits.Jealousy            = new Trait( "Jealousy", 'D', 'M', -10, false, "B3E34" );
...
Traits.LanguageTalent      = new Trait( "Language Talent", 'A', 'M', 2, true, "B3E20" );
...
Traits.Lame                = new Trait( "Lame", 'D', 'P', -10, true, "B3E29" );
Traits.Lame.fixedCost = -5;
Traits.Lame.lowestLevel = 1;
Traits.Lame.levelNames = ['crippled leg','one leg','legless/paraplegic'];
...
Traits.Lazy                = new Trait( "Laziness", 'D', 'M', -10, false, "B3E34" );
...
Traits.Literacy            = new Trait( "Literacy", 'A', 'M', 10, false, "B3E21" );
...
Traits.Luck                = new Trait( "Luck", 'A', 'M', 15, false, "B3E21" );
Traits.Luck.group = 'luck';
Traits.LuckExtraordinary   = new Trait( "Extraordinary Luck", 'A', 'M', 30, false, "B3E21" );
...
Traits.Magery              = new Trait( "Magery", 'A', 'M', 10, true, "B3E21" );
...
Traits.Miserliness         = new Trait( "Miserliness", 'D', 'M', -10, false, "B3E34" );
...
Traits.MusicalAbility      = new Trait( "Musical Ability", 'A', 'M', 1, true, "B3E22" );
...
Traits.NightVision         = new Trait( "Night Vision", 'A', 'P', 10, false, "B3E22" );
...
Traits.OneArm              = new Trait( "One Arm", 'D', 'P', -20, false, "B3E29" );
Traits.OneEye              = new Trait( "One Eye", 'D', 'P', -15, false, "B3E29" );
...
Traits.Overconfidence      = new Trait( "Overconfidence", 'D', 'M', -10, false, "B3E34" );
...
Traits.Pacifism            = new Trait( "Pacifism", 'D', 'M', -15, true, "B3E35" );
...
Traits.Phobia              = new Trait( "Phobia", 'D', 'M', -5, true, "B3E35" );
...
Traits.RapidHealing        = new Trait( "Rapid Healing", 'A', 'P', 5, false, "B3E23" );
Traits.RapidHealing.group = 'healing';
Traits.VeryRapidHealing    = new Trait( "Very Rapid Healing", 'A', 'P', 15, false, "CI31" );
...
Traits.Reputation          = new Trait( "Reputation", 'AD', 'So', 5, true, "B3E17" );
...
Traits.ResistanttoPoison   = new Trait( "Resistant to Poison", 'A', 'P', 5, false, "CI29" );
...
Traits.SenseOfDuty         = new Trait( "Sense of Duty", 'D', 'M', -5, true, "B3E39" );
...
Traits.SingleMinded        = new Trait( "Single-Minded", 'A', 'M', 5, false, "CI30" );
Traits.Skinny              = new Trait( 'Skinny', 'D', 'P', -5, false, "B3E29" );
...
Traits.Stubborn            = new Trait( "Stubbornness", 'D', 'M', -5, false, "B3E37" );
...
Traits.StrongWill          = new Trait( "Strong Will", 'A', 'M', 4, true, "B3E23" );
...
Traits.Toughness           = new Trait( "Toughness", 'A', 'P', 15, true, "B3E23" );
...
Traits.Truthfulness        = new Trait( "Truthfulness", 'D', 'M', -5, false, "B3E37" );
...
Traits.Voice               = new Trait( "Voice", 'A', 'P', 10, false, "B3E23" );
...
Traits.Vow                 = new Trait( "Vow", 'D', 'M', -5, true, "B3E37" );
...
Traits.WeakWill            = new Trait( "Weak Will", 'D', 'M', -8, true, "B3E37" );
...
Traits.Youth               = new Trait( "Youth", 'D', 'P', -2, true, "B3E29" );
Traits.Youth.levelsName = 'year';
